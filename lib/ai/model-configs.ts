...
// ============================================================================
// Google Gemini Configuration - STABLE 2.0/1.5 MODELS ONLY
// ============================================================================
 ...
 * Agent-Specific Model Recommendations (Gemini)
 * 
 * Based on current Gemini model capabilities (Jan 2026):
 * - gemini-2.0-flash: Best for chat, tools, and speed
 * - gemini-1.5-pro: Best for complex analysis and code
 * - gemini-1.5-flash: Reliable fallback/high volume
 */
export const AGENT_MODEL_RECOMMENDATIONS = {
  ...
  coder: {
    model: 'gemini-1.5-pro',
    reason: 'Strong coding with specialized training',
    fallback: 'gemini-2.0-flash',
  },
